...
lark.APP_ID = "cli_a896837e72ffd01c"
lark.APP_SECRET = "W2mlCxnHzImJ8SWOEA9VLcOhtT35ejcS"
# res_content = "我将为你搜索Ozon销售额的数据信息"
...
def do_p2_im_message_receive_v1(data: P2ImMessageReceiveV1) -> None:
    ...
    content = json.dumps(
        {
            "text": f'已发送至飞书云文档-Ozon交易清单数据与飞书API交互-Ozon销售额数据（飞书自动化版）'
        }
    )
